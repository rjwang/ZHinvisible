...
CUTTING = "(Zmetphi > 2.6)*(REDmet > 110)*((met/zpt)>0.8)*((met/zpt)<1.2)*(mass > 76)*(mass < 106)*(pBveto>0.0)*(training>0.0)" #no raw booleans! put (bool > 0.0)
...
inputdir = "/afs/cern.ch/work/c/chasco/WW_7/Addon/"
