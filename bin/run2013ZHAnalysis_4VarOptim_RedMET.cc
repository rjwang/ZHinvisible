...
int main(int argc, char* argv[])
{
    ...
    TString fitParametersFile = "/afs/cern.ch/work/r/rewang/Zhllnunu/CMSSW_5_3_3_patch2/src/CMGTools/HtoZZ2l2nu/src/MuScleFitCorrector_v4_1/";
    if(use2011Id) {
...
//Fast check hists
    ...
    for(size_t ivar=0; ivar<nvarsToInclude; ivar++) {
        ...
        //mon.addHistogram( new TH2F (TString("dphiLL1Dshape")+varNames[ivar],";cut index;#Delta#phi_{ll} [rad];Events",optim_Cuts1_met.size(),0,optim_Cuts1_met.size(),40,0.,TMath::Pi()) );
...
*/
	...
	//passMTcut &= passdphi2l;
        ...
        bool WWCtrl_RJ  ( passZpt && passRedMetWWCtrl  && passBveto /*&& passBalanceCutWWCtrl && (nAJetsGood30==0)*/ && pass3dLeptonVeto);
        ...
        if(has3dLepton && passSameFlavor) {
            ...
            */
            ...
            double new3rdMT = METUtils::transverseMass(rel3rdLep,zvvs[0],false);
